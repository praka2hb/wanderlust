...
const DateSelector = ({date, setDate}: any) => {
  ...
  return (
    <div>
        <button className='inline-flex items-center gap-2 text-[13px] font-medium text-lime-500 bg-lime-200/40 hover:bg-lime-200/70 rounded px-2 py-1 cursor-pointer' onClick={()=>{
        ...
        {openDatePicker && <div className='overflow-y-scroll p-5 bg-lime-50/80 rounded-lg relative pt-9'>
            <button
